...
Check the [releases](https://github.com/droboports/jq/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/jq.git
cd jq
./build.sh
ls -la *.tgz
```
